...
brasil.unshift('Rondônia', 'Acre', 'Roraima');
console.log(brasil);
...
var nordeste = ['Paraíba', 'Pernambuco', 'Ceará', 'Rio Grande do Norte', 'Alagoas', 'Sergipe', 'Piauí', 'Sergipe', 'Bahia'];
...
/*
filtre o array criado acima, retornando somente os estados que tiverem 
ID ímpares. Atribua o valor à uma variável chamada `filter3`.
*/

var filter3 = map.filter(function(item, index){
    return item.id % 2 !== 0;
});
