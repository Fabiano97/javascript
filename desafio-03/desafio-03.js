...
console.log(pessoa.nomeCompleto()); // 'Olá! Meu nome é Carlos Pereira!' 
...
console.log(pessoa.andar(12));
console.log(pessoa.andar(24));
...
console.log(pessoa.caminhouQuantosMetros); // 42;
...
pessoa.apresentacao = function(){
    ...
    return 'Olá, eu sou '+ sexo +' '+ pessoa.nome +' '+ pessoa.sobrenome +', tenho '+ pessoa.idade +' '+ idade +', '+ pessoa.altura +', meu peso é '+ pessoa.peso +' e, só hoje, eu já caminhei '+ pessoa.caminhouQuantosMetros +' '+ quantidadeMetros +'!';
}
