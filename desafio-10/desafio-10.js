...
operationSignal = '+';
var sum = calculator(operationSignal, number1, number2);
...
operationSignal = '-';
var subtraction = calculator(operationSignal, number1, number2);
...
operationSignal = '*';
var multiplication = calculator(operationSignal, number1, number2);
...
operationSignal = '/';
var division = calculator(operationSignal, number1, number2);
...
operationSignal = '%';
var mod = calculator(operationSignal, number1, number2);
...
operationSignal = 'x';
var reX = calculator(operationSignal, number1, number2);

if(reX){
    number1 = 10;
    number2 = 15;
    
    console.log(showOperationMessage(operationSignal, number1, number2), reX(number1, number2));
} 
else{
    console.log(showErrorMessage(operationSignal));    
}
